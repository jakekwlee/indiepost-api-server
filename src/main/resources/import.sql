...
INSERT INTO DetaillistReformed SELECT
                                 parent                                AS id,
                                 GROUP_CONCAT(
                                     IF(type = 1, CONCAT('<p>', data, '</p>'), CONCAT('<p><img src="', data, '"></p>'))
                                     ORDER BY iorder ASC SEPARATOR '') AS content,
                                 ispay
                               FROM detaillist
                               GROUP BY parent;
...
INSERT INTO Categories (id, displayOrder, name, slug) VALUES (11, 2, 'Music', admin'music');
...
INSERT INTO MediaContents (id, location, mimeType, price, isPaidContent) SELECT
                                                                           no,
                                                                           data,
                                                                           'image/jpeg',
                                                                           0,
...
-- Migrate Posts
INSERT INTO Posts (id, title, titleImage, excerpt, content, status, bookmarkedCount, commentsCount, likesCount, createdAt, modifiedAt, publishedAt, reservedAt, authorId, editorId, categoryId) SELECT
                                                                                                                                                                                                  c.no,
                                                                                                                                                                                                  c.CONTENTNAME,
                                                                                                                                                                                                  c.IMAGEURL,
                                                                                                                                                                                                  c.CONTENTTEXT,
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  c.MENUNO
                                                                                                                                                                                                FROM
                                                                                                                                                                                                  contentlist AS c INNER JOIN
                                                                                                                                                                                                  DetaillistReformed AS d
                                                                                                                                                                                                    ON
                                                                                                                                                                                                      c.no
                                                                                                                                                                                                      =
                                                                                                                                                                                                      d.id;
...
INSERT INTO Posts_MediaContents (postId, mediaContentId) SELECT
                                                           parent,
                                                           no
                                                         FROM detaillist
                                                         WHERE type = 2;
