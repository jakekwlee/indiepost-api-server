...
-- Migrate Images
INSERT INTO Images (id, directory, original, thumbnail, postId, filesize, height, width, isFeatured, uploadedAt)
  SELECT d.no, SUBSTRING_INDEX(d.data, '/', 5), SUBSTRING_INDEX(d.data, '/', -1), SUBSTRING_INDEX(d.data, '/', -1), d.parent, 0, 0, 0, FALSE, STR_TO_DATE(c.REGDATE, '%Y%m%d')
