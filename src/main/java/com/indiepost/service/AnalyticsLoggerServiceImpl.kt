...
class AnalyticsLoggerServiceImpl @Inject constructor(
    ...
    @Throws(IOException::class)
    override fun logClickAndGetLink(req: HttpServletRequest, res: HttpServletResponse, principal: Principal?, linkUid: String?): String {
        ...
        if (principal != null) {
            userId = userService.findCurrentUser().id
        }
