 ...
 */
@Transactional
abstract class AbstractImageService @Inject constructor(
    ...
    override fun findImagesOnPost(postId: Long): PostImageSetDto {
        val post = postRepository.findById(postId) ?: throw ResourceNotFoundException("No post with id: $postId")
    ...
    override fun deleteById(id: Long): Long? {
        val imageSet = findById(id) ?: return null
        delete(imageSet)
        return id
    }
