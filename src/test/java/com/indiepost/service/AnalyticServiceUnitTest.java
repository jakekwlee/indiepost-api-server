...
public class AnalyticServiceUnitTest {
    ...
    public void normalizeTimeDomainStatsWorksCorrectly() throws JsonProcessingException {
        ...
        Date d1 = DateUtils.newDate(2017, 1, 1, 4, 0, 0);
        Date d2 = DateUtils.newDate(2017, 1, 1, 10, 0, 0);
        ...
        List<TimeDomainStat> output =
                DateUtils.normalizeTimeDomainStats(input, Period.between(LocalDate.of(2017, 1, 1), LocalDate.of(2017, 1, 1)));
