 ...
 */
class DomUtilUnitTests {

    @Test
    @Throws(JsonProcessingException::class)
    fun getImagePrefixesShouldExtractImagePrefixesFromPostContent() {
    ...
    @Test
    fun htmlToTextShouldWorkProperly() {
        val text = DomUtil.htmlToText(content)
    ...
    companion object {
        ...
        private val content = "<p>인디포스트는 동영상 스트리밍 서비스 옥수수(oksusu)와 함께 작품성 있는 영화를 선별해 추천하는 무료영화 이벤트를 진행합니다. 10월 14일 토요일부터 16일 월요일까지, 3일 동안 통신사 관계없이 누구나 옥수수에서 무료로 영화를 감상할 수 있습니다. 모바일 앱과 웹사이트에서 모두 볼 수 있으며, 중단 후에는 언제든지 &lsquo;이어보기&rsquo;로 다시 감상할 수 있습니다.</p>\n" +
